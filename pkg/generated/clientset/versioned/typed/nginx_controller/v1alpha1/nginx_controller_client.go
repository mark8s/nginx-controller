...
import (
	...
	"nginx-controller/pkg/generated/clientset/versioned/scheme"
...
// DemoV1alpha1Client is used to interact with features provided by the demo.mark8s.io group.
type DemoV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DemoV1alpha1Client) Nginxes(namespace string) NginxInterface {
